(function () {
    ...
    function manipulateImage(type) {
        ...
        // Posting image to the web worker
        postImage(type, imageData);
    ...
    /**
     * Post image to the web worker for processing
     * out of the main thread
     * @param type Type of the manipulation
     * @param imageData Image data to process
     */
    function postImage(type, imageData) {
        worker.postMessage({
            type: type,
            imageData: imageData
        });
